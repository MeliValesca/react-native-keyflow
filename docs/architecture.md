...
The cursor navigators use native caret/layout geometry for vertical visual-line movement and keep a preferred horizontal column. Horizontal steps retain composed-character boundaries.
