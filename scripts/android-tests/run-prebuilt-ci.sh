...
keyflow_native_status=0
python3 scripts/android-tests/instrumentation.py "$keyflow_output" || keyflow_native_status=$?
...
keyflow_app_status=0
python3 scripts/android-tests/app.py "$keyflow_output" || keyflow_app_status=$?
